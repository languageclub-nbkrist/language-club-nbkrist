...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/languageclub/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@languageclub",
    icon: Instagram,
    url: "https://www.instagram.com/languageclubnbkrist?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@languageclub",
    icon: Github,
    url: "https://github.com/languageclub-nbkrist/language-club-nbkrist",
    color: "#ffffff",
